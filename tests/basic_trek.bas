...
70 REM **** ORIGIONAL PROGRAM BY MIKE MAYFIELD, MODIF IED VERSION
...
215 REM ***
220 FOR PP=1 TO 10: PRINT : NEXT PP
221 PRINT "                                    ,------*------,"
222 PRINT "                    ,-------------   '---  ------'"
223 PRINT "                     '-------- --'      / /"
224 PRINT "                         ,---' '-------/ /--,"
...
227 FOR PP=1 TO 5: PRINT : NEXT PP
260 REM CLEAR 600
270 Z$="                         "
...
1390 IF Q1<1ORQ1>8ORQ2<1ORQ2>8 THEN 1600
...
1720 FORI=1TOK3 :  GOSUB 8590 : A$="+K+" : Z1=R1 : Z2=R2
...
1910 FORI=1TOS3 :  GOSUB 8590 : A$=" * " : Z1=R1 : Z2=R2 :  GOSUB 8670 : NEXTI
1980  GOSUB 6430
1990 IF S+E>10 THEN IF E>10ORD(7)=0 THEN 2060
...
2080 FORI=1TO9 : PRINT MID$(A1$,3*I-2,3) :IF LEFT$(A$,3)<>MID$(A1$,3*I-2,3) THEN 2160
...
2360 PRINT "WARP FACTOR (0-";X$;")"; : INPUT W1 : IF D(1)<0ANDW1>.2 THEN 2470
2380 IF W1>0ANDW1<=8 THEN 2490
...
2590 FORI=1TOK3 : IF K(I,3)=0 THEN 2700
2610 A$="   " : Z1=K(I,1) : Z2=K(I,2) :  GOSUB 8670 :  GOSUB 8590
2660 K(I,1)=Z1 : K(I,2)=Z2 : A$="+K+" :  GOSUB 8670
2700 NEXTI :  GOSUB 6000 : D1=0 : D6=W1 : IF W1>=1 THEN D6=1
2770 FORI=1TO8 : IF D(I)>=0 THEN 2880
2790 D(I)=D(I)+D6 : IF D(I)>-.1ANDD(I)<0 THEN D(I)=-.1 :   GOTO 2880
...
2880 NEXTI : IF RND(1)>.2 THEN 3070
...
3170 FORI=1TON : S1=S1+X1 : S2=S2+X2 : IF S1<1ORS1>=9ORS2<1ORS2>=9 THEN 3500
...
4180 NEXTJ : FORL=1TO3 : PRINT ": "; : IF N(L)<0 THEN PRINT "*** "; :   GOTO 4230
4210 PRINT RIGHT$(STR$(N(L)+1000),3);" ";
4230 NEXTL : PRINT ": " : PRINT O1$ : NEXTI :   GOTO 1990
...
4450 H1=INT(X/K3) : FORI=1TO3 : IF K(I,3)<=0 THEN 4670
...
5150 FORI=1TO3 : IF X3=K(I,1)ANDY3=K(I,2) THEN 5190
5180 NEXTI : I=3
...
5720 D3=0 : FORI=1TO8 : IF D(I)<0 THEN D3=D3+.1
5760 NEXTI : IF D3=0 THEN 1990
...
6540 NEXTJ : NEXTI : D0=0 :   GOTO 6650
...
6770 O1$="---------------------------------" : PRINT O1$ : FORI=1TO8
6820 FORJ=(I-1)*24+1TO(I-1)*24+22STEP3 : PRINT " ";MID$(Q$,J,3); : NEXTJ
6830 ONI  GOTO 6850,6900,6960,7020,7070,7120,7180,7240
...
7350 PRINT  : H8=1 : ONA+1  GOTO 7540,7900,8070,8500,8150,7400
...
7560 O1$="     ----- ----- ----- ----- ----- ----- ----- -----"
7570 PRINT O1$ : FORI=1TO8 : PRINT I; : IF H8=0 THEN 7740
7630 FORJ=1TO8 : PRINT "   "; : IF Z(I,J)=0 THEN PRINT "***"; :   GOTO 7720
...
7850 PRINT  : PRINT O1$ : NEXTI : PRINT  :   GOTO 1990
...
8100 H8=0 : FORI=1TO3 : IF K(I,3)<=0 THEN 8480
...
8790 ONR1  GOTO 8792,8794,8796,8798,8800,8802,8804,8806
...
9030 IF Z5<=4 THEN ONZ4  GOTO 9040,9050,9060,9070,9080,9090,9100,9110
9035   GOTO 9120
...
9120 ONZ4  GOTO 9130,9140,9150,9160,9170,9180,9190,9200
